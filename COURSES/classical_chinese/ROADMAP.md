...
`TASK-CLCH-GOV-000` created the governance shell. `TASK-CLCH-GOV-001` hardened the course boundary. `TASK-CLCH-GOV-002` established the cross-agent entry layer. `TASK-CLCH-GOV-003` now hardens source authority and copyright boundaries so later agents cannot mistake textbook metadata, NotebookLM extraction notes, or agent drafts for classroom-ready content.

This course has not yet entered approved teaching design. Governance must next harden task routing and naming consistency after source authority is locked. Material work must still begin with knowledge extraction and a `16-session core material matrix`, not with lesson prose.
...
5. `TASK-CLCH-GOV-004` | Task Routing And Naming Convention Contract | next
6. `TASK-CLCH-MAT-001` | Knowledge Map Extraction | planned
7. `TASK-CLCH-MAT-002` | 16-Session Core Material Matrix | planned
8. `TASK-CLCH-DES-001` | 16-Week Course Architecture | planned
9. `TASK-CLCH-DES-002` | Unit Template And Lesson Design Contract | planned
10. `TASK-CLCH-AI-001` | AI/Vibecoding Learning Activity Boundary | planned
11. `TASK-CLCH-ASSESS-001` | Assessment And Assignment Framework | planned
...
- `TASK-CLCH-GOV-004` must align task routing and naming rules before material and design families expand
